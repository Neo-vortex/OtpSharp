...
using OtpNet;
using OtpSharper.Algorithms; // Otp.NET (competitor)
using OtpSharper.Core;                       // Our library
...
/// Compares OtpSharper vs Otp.NET (kspearrin) under identical conditions.
/// </summary>
[MemoryDiagnoser]
[CategoriesColumn]
