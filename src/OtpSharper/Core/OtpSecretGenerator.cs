...
public static class OtpSecretGenerator
{
    ...
    public static OtpSecret GenerateForAlgorithm(OtpAlgorithm algorithm)
    {
    ...
    /// </summary>
    public static int RecommendedSecretBytes(OtpAlgorithm algorithm) => algorithm switch
    {
        OtpAlgorithm.HmacSha1     => 20,  // 160-bit output
        OtpAlgorithm.HmacSha256   => 32,  // 256-bit output
        OtpAlgorithm.HmacSha384   => 48,  // 384-bit output
        OtpAlgorithm.HmacSha512   => 64,  // 512-bit output
        OtpAlgorithm.HmacSha3_256 => 32,
        OtpAlgorithm.HmacSha3_512 => 64,
        _                                              => 32,
    };
