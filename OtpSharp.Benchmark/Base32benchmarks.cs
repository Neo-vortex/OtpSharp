...
public class Base32Benchmarks
{
    ...
    [BenchmarkCategory("Base32_Encode_20bytes")]
    public string OurEncode20() => OtpSharp.Core.Base32.Encode(Bytes20, padOutput: false);
    ...
    [Benchmark(Description = "OtpSharp")]
    [BenchmarkCategory("Base32_Encode_32bytes")]
    public string OurEncode32() => OtpSharp.Core.Base32.Encode(Bytes32, padOutput: false);
    ...
    [Benchmark(Description = "OtpSharp")]
    [BenchmarkCategory("Base32_Encode_64bytes")]
    public string OurEncode64() => OtpSharp.Core.Base32.Encode(Bytes64, padOutput: false);
    ...
    [Benchmark(Description = "OtpSharp")]
    [BenchmarkCategory("Base32_Decode_20bytes")]
    public byte[] OurDecode20() => OtpSharp.Core.Base32.Decode(Base32_20);
    ...
    [Benchmark(Description = "OtpSharp")]
    [BenchmarkCategory("Base32_Decode_32bytes")]
    public byte[] OurDecode32() => OtpSharp.Core.Base32.Decode(Base32_32);
    ...
    [Benchmark(Description = "OtpSharp")]
    [BenchmarkCategory("Base32_Decode_64bytes")]
    public byte[] OurDecode64() => OtpSharp.Core.Base32.Decode(Base32_64);
}
